...
<main class="contrat">
	<section class="section-table" id="contrat-table">
		<div class="table">
			...
			<div class="table-content tbody">
				<?php
				foreach ($contrat_all as $data) {
					$debut = $data['debut'];
					$fin = $data['fin'];
					$adress = $data['adress'];
					$locataire = $data['email'];
					
					$ligne_data = "
					<p class='td'>$debut</p>
					<p class='td'>$fin</p>
					<p class='td'>$adress</p>
					<p class='td'>$locataire</p>
					<a href='#' class='td'>
						<span class='btn'>
							select
						</span>
	...
	<section class="section-form" id="contrat-add">
		<fieldset>
			<legend>Ajout contrat</legend>
			<form action="">
				<?php
